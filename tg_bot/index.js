...
const TOKEN = "5119110788:AAEhicjBKkZgr6Fol6ZdLVLgEyGLnGodSC4";
const server = express();
const bot = new TelegramBot(TOKEN, {
    polling: true
});
const port = process.env.PORT || 5000;
const gameName = "bigVOPA";
const queries = {};
server.use(express.static(path.join(__dirname, 'bigVOPA')));
...
bot.on("callback_query", function (query) {
    if (query.game_short_name !== gameName) {
        ...
        //let gameurl = "file:///C:/Users/dimak/Desktop/Казино/bigVOPA/Plinko.html";
