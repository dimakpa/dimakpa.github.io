...
<script>
   ...
   Telegram.WebApp.onEvent('mainButtonClicked', function(){
      tg.sendData('{ "employees" :[{"id":1,"name":"first","description":"first desc","in_stock":23,"price":3333333,"image":"/none","manufacturer":1},{"id":2,"name":"second","description":"second desc","in_stock":233,"price":4444444,"image":"/none","manufacturer":1}]}' );
